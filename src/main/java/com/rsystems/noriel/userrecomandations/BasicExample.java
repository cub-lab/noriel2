...
public class BasicExample {
     ...
     */
    public String azureConn() throws IOException {

        /*
         * From the Azure portal, get your Storage account's name and account key.
         */
        String accountName = "cub02";
        String accountKey = "dSwJM3Ys+/TxXDKLcv4jJ57zy5zz+b9H+xamc+tt8vd3gv8Ofo3PWdwuOuMRo9h9sC+sCtMUgweyf6nsdYWY0g==";
         ...
         */
        BlobContainerClient blobContainerClient = storageClient.getBlobContainerClient("cubcontainer011618789317300");
